...
export default function SolutionDetailPage() {
  ...
  const handleAuditSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    if (tokenAddress) {
      // Redirect to home page with token address as search parameter
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              {/* Warning Alert for risk-related pages */}
            ...
            <div className="lg:col-span-1">
              ...
              <div className="mt-8 bg-gradient-to-r from-primary/5 to-primary/10 rounded-lg border border-primary/20 p-6 shadow-sm">
                ...
                <button className="bg-primary hover:bg-primary/90 text-white px-6 py-3 rounded-lg font-medium transition-colors w-full flex items-center justify-center gap-2">
